...
.stTextInput>div>div>input {color: white; background-color: #1C2541; border-radius: 12px;}
</style>
...
def show_products(product_list):
    ...
    for i, p in enumerate(product_list):
        with cols[i % 2]:
            ...
            # FIX: Check if image exists, else placeholder
            img_url = p.get("image_url") or "https://via.placeholder.com/400x400/1C2541/FFFFFF?text=VEYRA"
